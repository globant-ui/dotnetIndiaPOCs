...
namespace CurrentLocation.MockData
{
    public class AssetPositionsData
    {
        public List<MainAssetPositions> GetAssetPositonsData()
        {
            ...
            {
                 new MainAssetPositions { Title= "Swimming Pool", Description="Swimming Pool Description", AssetLatitude = 33.587459, AssetLongitude=-117.844433, MarkerIcon = "AssetMarker",
                 ...
                 new MainAssetPositions { Title= "Backflow Preventer", Description="Backflow Preventer Description", AssetLatitude = 33.587383, AssetLongitude=-117.843669, MarkerIcon = "AssetMarker",
                ...
                new MainAssetPositions { Title= "Hose Bib", Description="Hose Bib Description", AssetLatitude = 33.586081, AssetLongitude=-117.844663, MarkerIcon = "AssetMarker",
                ...
                new MainAssetPositions { Title= "Point of Connection", Description="Point of Connection Description", AssetLatitude = 33.586025, AssetLongitude=-117.844051, MarkerIcon = "AssetMarker",
                 ...
                 new MainAssetPositions { Title= "Quick Coupler", Description="Quick Coupler Description", AssetLatitude = 33.587100, AssetLongitude=-117.843115, MarkerIcon = "AssetMarker",
