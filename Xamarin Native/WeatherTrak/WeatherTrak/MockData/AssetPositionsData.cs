    ...
    public class AssetPositionsData
    {
        public List<MainAssetPositions> GetAssetPositonsData()
        {
            List<MainAssetPositions> listAssetPositions = new List<MainAssetPositions>
            {
                  ...
                  new MainAssetPositions { Title= "Swimming Pool", Description="Controller Site", AssetLatitude = 33.6136130090882, AssetLongitude=-117.861306332052, MarkerIcon = "AssetMarker",
                 ...
                 new MainAssetPositions { Title= "Backflow Preventer", Description="Backflow Preventer Description", AssetLatitude = 33.5981026435454, AssetLongitude=-117.85422295332, MarkerIcon = "AssetMarker",
                ...
                new MainAssetPositions { Title= "Hose Bib", Description="Hose Bib Description", AssetLatitude = 33.5765697610906, AssetLongitude=-117.842677384615, MarkerIcon = "AssetMarker",
                ...
                new MainAssetPositions { Title= "Point of Connection", Description="Point of Connection Description", AssetLatitude = 33.598397267355, AssetLongitude=-117.83690392971, MarkerIcon = "AssetMarker",
                 ...
                 new MainAssetPositions { Title= "Quick Coupler", Description="Quick Coupler Description", AssetLatitude = 33.610870241249, AssetLongitude=-117.826809771359, MarkerIcon = "AssetMarker",
